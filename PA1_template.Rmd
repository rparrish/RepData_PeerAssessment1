...
```{r}
#| label: histogram_of_daily_steps
...
```{r}
#| label: time_series_average_steps_by_interval
...
```{r}
#| label: histogram_of_imputed_daily_steps 
...
```{r}
#| label: weekday_weekend_comparison 
